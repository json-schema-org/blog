       ...
       <div className="relative pt-8 pb-20 px-4 sm:px-6 lg:pt-6 lg:pb-28 lg:px-8">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="max-w-2xl mx-auto text-md leading-7 text-gray-400">
              We have an <img className="ml-1 text-primary-500 hover:text-primary-400" style={{ display: 'inline' }} src="/blog/img/logos/rss.svg" height="18px" width="18px" /> <Link className="ml-1 text-primary-500 hover:text-primary-400" href="/rss.xml">RSS Feed</Link> too!
            </p>
          </div>
